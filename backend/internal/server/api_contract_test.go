		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"gateway_audit_file_enabled": false,
					"gateway_audit_file_path": "",
					"gateway_audit_ops_index_enabled": false,
					"gateway_audit_index_enabled": false,
					"gateway_audit_index_async_enabled": false,
					"gateway_audit_index_queue_size": 0,
					"gateway_audit_index_worker_count": 0,
					"gateway_audit_index_batch_size": 0,
					"gateway_audit_index_flush_interval_ms": 0,
					"gateway_audit_index_write_timeout_ms": 0,
					"gateway_audit_backfill_enabled": false,
					"gateway_audit_backfill_interval_ms": 0,
					"gateway_audit_backfill_batch_size": 0,
					"gateway_audit_retention_cleanup_interval_minutes": 0,
					"gateway_audit_max_input_body_bytes": 65536,
					"gateway_audit_max_output_body_bytes": 131072,
					"gateway_audit_max_string_value_bytes": 0,
					"gateway_audit_max_array_items": 0,
					"gateway_audit_max_object_depth": 0,
					"gateway_audit_sample_rate": 0,
					"gateway_audit_include_paths": null,
					"gateway_audit_exclude_paths": null,
					"gateway_audit_redact_keys": null,
					"gateway_audit_retention_days": 0,
					"openai_advanced_scheduler_enabled": true,
