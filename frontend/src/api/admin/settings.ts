...
export interface SystemSettings {
  ...
  gateway_audit_index_batch_size: number;
  gateway_audit_index_flush_interval_ms: number;
  gateway_audit_index_write_timeout_ms: number;
  gateway_audit_backfill_enabled: boolean;
  gateway_audit_backfill_interval_ms: number;
  gateway_audit_backfill_batch_size: number;
  gateway_audit_retention_cleanup_interval_minutes: number;
  gateway_audit_max_input_body_bytes: number;
  gateway_audit_max_output_body_bytes: number;
  gateway_audit_max_string_value_bytes: number;
  gateway_audit_max_array_items: number;
  gateway_audit_max_object_depth: number;
  gateway_audit_sample_rate: number;
  gateway_audit_include_paths: string[];
  gateway_audit_exclude_paths: string[];
  gateway_audit_redact_keys: string[];
