export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        gatewayAuditConfigTitle: 'Audit Capture and Indexing',
        gatewayAuditRuntimeHint: 'Request capture updates apply live; worker/backfill scheduling changes apply after restart.',
        gatewayAuditRestartRequired: 'restart',
        gatewayAuditFullCaptureWarning: 'Full capture stores complete redacted request or response bodies up to the configured hard limit. Keep byte limits tight and review redaction keys before enabling it in production.',
        gatewayAuditCaptureSection: 'Capture',
        gatewayAuditPipelineSection: 'Storage and Pipeline',
        gatewayAuditFilterSection: 'Filtering and Redaction',
        gatewayAuditInputCaptureMode: 'Input capture mode',
        gatewayAuditOutputCaptureMode: 'Output capture mode',
        gatewayAuditInputMessagePolicy: 'Input message policy',
        gatewayAuditSampleRate: 'Sample rate',
        gatewayAuditRetentionDays: 'Retention days',
        gatewayAuditMaxInputBodyBytes: 'Max input bytes',
        gatewayAuditMaxOutputBodyBytes: 'Max output bytes',
        gatewayAuditMaxStringValueBytes: 'Max preview string bytes',
        gatewayAuditMaxArrayItems: 'Max preview array items',
        gatewayAuditMaxObjectDepth: 'Max preview object depth',
        gatewayAuditFileEnabled: 'Write JSONL/WAL',
        gatewayAuditFilePath: 'JSONL/WAL file path',
        gatewayAuditOpsIndexEnabled: 'Write ops audit log',
        gatewayAuditIndexEnabled: 'Postgres query index',
        gatewayAuditIndexAsyncEnabled: 'Async index workers',
        gatewayAuditIndexQueueSize: 'Index queue size',
        gatewayAuditIndexWorkerCount: 'Index worker count',
        gatewayAuditIndexBatchSize: 'Index batch size',
        gatewayAuditIndexFlushIntervalMs: 'Index flush interval (ms)',
        gatewayAuditIndexWriteTimeoutMs: 'Index write timeout (ms)',
        gatewayAuditBackfillEnabled: 'Backfill scanner',
        gatewayAuditBackfillIntervalMs: 'Backfill interval (ms)',
        gatewayAuditBackfillBatchSize: 'Backfill batch size',
        gatewayAuditRetentionCleanupIntervalMinutes: 'Retention cleanup interval (min)',
        gatewayAuditIncludePaths: 'Include paths',
        gatewayAuditExcludePaths: 'Exclude paths',
        gatewayAuditRedactKeys: 'Redact keys',
        gatewayAuditListPlaceholder: 'One item per line',
        auditCaptureNone: 'None',
        auditCaptureHash: 'Hash only',
        auditCapturePreview: 'Preview',
        auditCaptureFull: 'Full',
        auditInputPolicyAll: 'All input',
        auditInputPolicyUserMessages: 'User messages only',
        auditInputPolicyLastUserMessage: 'Latest user message',
        auditInputPolicyMetadataOnly: 'Metadata only',
