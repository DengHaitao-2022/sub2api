export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        gatewayAuditConfigTitle: '审计采集与索引',
        gatewayAuditRuntimeHint: '请求采集类配置保存后即时生效；worker、backfill 与定时任务类配置需重启后生效。',
        gatewayAuditRestartRequired: '需重启',
        gatewayAuditFullCaptureWarning: 'Full 采集会在硬上限内保存完整脱敏后的请求或响应正文。生产环境启用前请收紧字节上限并确认脱敏字段。',
        gatewayAuditCaptureSection: '采集策略',
        gatewayAuditPipelineSection: '存储与异步链路',
        gatewayAuditFilterSection: '过滤与脱敏',
        gatewayAuditInputCaptureMode: '输入采集模式',
        gatewayAuditOutputCaptureMode: '输出采集模式',
        gatewayAuditInputMessagePolicy: '输入消息策略',
        gatewayAuditSampleRate: '采样率',
        gatewayAuditRetentionDays: '保留天数',
        gatewayAuditMaxInputBodyBytes: '输入最大字节数',
        gatewayAuditMaxOutputBodyBytes: '输出最大字节数',
        gatewayAuditMaxStringValueBytes: '预览字符串上限',
        gatewayAuditMaxArrayItems: '预览数组元素上限',
        gatewayAuditMaxObjectDepth: '预览对象深度上限',
        gatewayAuditFileEnabled: '写入 JSONL/WAL',
        gatewayAuditFilePath: 'JSONL/WAL 文件路径',
        gatewayAuditOpsIndexEnabled: '写入 ops 审计日志',
        gatewayAuditIndexEnabled: 'PostgreSQL 查询索引',
        gatewayAuditIndexAsyncEnabled: '异步索引 worker',
        gatewayAuditIndexQueueSize: '索引队列大小',
        gatewayAuditIndexWorkerCount: '索引 worker 数量',
        gatewayAuditIndexBatchSize: '索引批量大小',
        gatewayAuditIndexFlushIntervalMs: '索引 flush 间隔（毫秒）',
        gatewayAuditIndexWriteTimeoutMs: '索引写入超时（毫秒）',
        gatewayAuditBackfillEnabled: 'Backfill 扫描器',
        gatewayAuditBackfillIntervalMs: 'Backfill 间隔（毫秒）',
        gatewayAuditBackfillBatchSize: 'Backfill 批量大小',
        gatewayAuditRetentionCleanupIntervalMinutes: 'Retention 清理间隔（分钟）',
        gatewayAuditIncludePaths: '包含路径',
        gatewayAuditExcludePaths: '排除路径',
        gatewayAuditRedactKeys: '脱敏键',
        gatewayAuditListPlaceholder: '每行一项',
        auditCaptureNone: '不采集正文',
        auditCaptureHash: '仅记录 Hash',
        auditCapturePreview: '预览',
        auditCaptureFull: '完整',
        auditInputPolicyAll: '全部输入',
        auditInputPolicyUserMessages: '仅用户消息',
        auditInputPolicyLastUserMessage: '最后一条用户消息',
        auditInputPolicyMetadataOnly: '仅元数据',
